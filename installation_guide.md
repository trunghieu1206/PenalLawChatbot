# Installation Guide — PenalLawChatbot

This guide describes the complete steps to deploy the **PenalLawChatbot** system on an **AWS EC2 Ubuntu 24.04** server **without Docker**.
