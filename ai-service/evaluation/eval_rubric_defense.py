...
def main():
    parser = base_arg_parser("RUBRIC evaluation — Defense (bào chữa) role.")
    args = parser.parse_args()
    if not args.output:
        args.output  = "ai-service/evaluation/results/rubric_defense_results.jsonl"
    if not args.summary:
        args.summary = "ai-service/evaluation/results/rubric_defense_summary.json"
